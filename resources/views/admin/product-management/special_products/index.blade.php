<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('product-management.special-products.index') }}
    @endsection
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="kt_modal_add_user_form" class="form"
                                action="{{ route('product-management.special-products.store') }}" method="POST"
                                ...
                                <div class="modal-body px-5 my-7">
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="title">Title In
                                                English</label>
                                            <!--end::Label-->
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" name="title_in_he"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="Enter Title In Hebrew" required />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="description"
                                                required>Description In English</label>
                                            <!--end::Label-->

                                            <textarea name="description" id="editor" required class=" form-control form-control-solid mb-3 mb-lg-0"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="description_in_he"
                                                required>Description In Hebrew</label>
                                            <!--end::Label-->

                                            <textarea name="description_in_he" id="editor" required class=" form-control form-control-solid mb-3 mb-lg-0"
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form
                                            action="{{ route('product-management.special-products.destroy', $item->id) }}"
                                        ...
                                        <form action="{{ route('product-management.special-products.edit', $item->id) }}"
            ...
            $(document).ready(function() {
                ...
                $(".switch-input").change(function() {
                    ...
                    if (this.checked)
                        ...
                        var status = 0;
                    $.ajax({
                        url: "{{ route('product-management.special-products.change.status') }}",
                        type: 'GET',
                        /*dataType: 'json',*/
                        data: {
                            'id': this.id,
