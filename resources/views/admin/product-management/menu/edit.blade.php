...
<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('product-management.menu.show', $data) }}
    @endsection
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body py-4 mx-20">
                    <!--begin::Form-->
                    <form action="{{ route('product-management.menu.update', $data->id ?? '') }}" method="POST"
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2" name="name">Menu Image</label>
                            <!--end::Label-->
                        </div>
                        <!--begin::Image input-->
