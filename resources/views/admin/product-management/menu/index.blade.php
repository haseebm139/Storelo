<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('product-management.menu.index') }}
    @endsection
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="kt_modal_add_user_form" class="form"
                                action="{{ route('product-management.menu.store') }}" method="POST"
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('product-management.menu.destroy', $item->id) }}"
                                        ...
                                        <form action="{{ route('product-management.menu.edit', $item->id) }}"
            ...
            $(document).ready(function() {
                ...
                $(".switch-input").change(function() {
                    ...
                    if (this.checked)
                        ...
                        var status = 0;
                    $.ajax({
                        url: "{{ route('product-management.menu.change.status') }}",
                        type: 'GET',
                        /*dataType: 'json',*/
                        data: {
                            'id': this.id,
