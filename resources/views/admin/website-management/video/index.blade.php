<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('website-management.video.index') }}
    @endsection
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="kt_modal_add_user_form" class="form"
                                action="{{ route('website-management.video.store') }}" method="POST"
                                ...
                                <div class="modal-body px-5 my-7">
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <input type="file" name="path" accept="video/mp4,video/webm,video/ogg"
                                                required class="form-control form-control-solid mb-3 mb-lg-0" />
                                            <!--end::Input-->
                                        </div>
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        @isset($data)
                            ...
                            @foreach ($data as $item)
                                @php
                                    $video = $item->path ?? 'web_assets/video/video.mp4';
                                @endphp
                                <tr>

                                    <td><video muted autoplay loop width="50%" class="video-mar">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('website-management.video.destroy', $item->id) }}"
                                        ...
                                        <form action="{{ route('website-management.video.edit', $item->id) }}"
            ...
            $(document).ready(function() {
                ...
                $(".switch-input").change(function() {
                    ...
                    if (this.checked)
                        ...
                        var status = 0;
                    $.ajax({
                        url: "{{ route('website-management.video.change.status') }}",
                        type: 'GET',
                        /*dataType: 'json',*/
                        data: {
                            'id': this.id,
